...
// (e.g. the GitHub token from App Settings) and a newline would let it inject
// arbitrary extra KEY=value lines into .env — including ones this app trusts
// without a restart, like GITHUB_REPO.
